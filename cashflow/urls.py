...
urlpatterns = [   
    ...
    path('add-income-mobile/', add_income_mobile, name='add_income_mobile'),
    path('add-spending-mobile/', add_spending_mobile, name='add_spending_mobile'),
    path('delete-income/<int:id>', delete_income, name='delete_income'),
    path('delete-spending/<int:id>', delete_spending, name='delete_spending'),
